                ...
                <div id="product-filters">
                    <Container fluid className="">
                        <Row className="justify-content-around align-items-center flex-row">
                                                    ...
                                                    <div key={index} className="form-check my-3 dropdown-item">
                                                        <label className="form-check-label">
                                                            <input type="checkbox" className="form-check-input"
                                                                   ...
                                                                   onChange={handleChange} value={category.category}/>
                                                    ...
                                                    <div key={index} className="form-check my-3 dropdown-item">
                                                        <label className="form-check-label">
                                                            <input type="checkbox" className="form-check-input"
                                                                   ...
                                                                   onChange={handleChange} value={store.store_type}/>
                            ...
                            <Col xs={2}>
                                <Button block type="button" variant="danger" onClick={handleClick}>Применить</Button>
                            </Col>
                            <Col xs={4}>
